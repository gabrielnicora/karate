 function fn() {
   ...
   var config = { // base config JSON
       togglesFeatureBaseUrl: env_data.togglesFeatureBase,
       peopleHubBaseUrl: env_data.peopleHub,
       signBaseUrl: env_data.sign,
       appBundleId: env_data.appBundleId,
       scoringBaseUrl: env_data.scoring,
       loansBaseUrl: env_data.loans,
       mailingManagerBaseUrl: env_data.mailingManager,
       insuranceBaseUrl : env_data.insurance,
       insuranceSancorBaseUrl: env_data.insuranceSancor,
       trackingBaseUrl: env_data.tracking,
       wiremockBaseUrl: env_data.wiremock,
       customersBaseURL : env_data.customers,
       bffmobileBaseUrl: env_data.bffmobile,
       interbankingUrl: env_data.interbanking,
       bdsUrl: env_data.bds,
       directdebitsUrl: env_data.directdebits,
       debitscardsUrl: env_data.debitscards,
       transfermanagerUrl: env_data.transfermanager,
       accountTransactionsUrl: env_data.account,
       coelsaUrl: env_data.coelsa,
       localWiremock: env_data.localWiremock,
       bffmobileMulticolor: env_data.bffmobileMulticolor,
       bffmobileIntegration: env_data.bffmobileIntegration,
       randomCuil: makecuil(),
       ...
       insuranceEditCancelationReasonInexistente: user_data.insuranceEditCancelationReason,
       insuranceEditCancelationReason: user_data.insuranceEditCancelationReason,
       insuranceSecondCancelationReason: user_data.insuranceSecondCancelationReason
   };
