@insurance-manager
Feature: Serivcio para la Confirmación de la solicitud de seguro ATM
...
Background:
    ...
    * def mail = "hmateikabdsolqe@gmail.com"
    ...
    Scenario:  BDSD-19764 - Se emite una poliza de ATM correctamente y los campos del response son correctos
