 @bff-mobile @activities
Feature: Obtener respuesta exitosa del endpoint Activities en la home

  Background:
    * url bffmobileBaseUrl

  Scenario: Obtenego actividades de mi cuenta desde el BFF con mi JWT
    ...
    """
{
    ...
    * def accessToken = response.accessToken
    ...
    Scenario: Intento no exitoso de obtener actividades de otra cuenta usando otro JWT activo
    Given path 'api/auth/link-account-token'
    And header Content-Type = 'application/json'
    ...
    """
{
    ...
    Then status 201
    * def accessToken = response.accessToken
    And path 'api/me/activities/1200000036/home'
    And header Authorization = "Bearer " + accessToken
    When method get
    Then status 404